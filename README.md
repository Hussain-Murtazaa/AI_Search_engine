...
bashgit clone https://github.com/Hussain-Murtazaa/AI_Search_engine.git
cd AI_Search_engine
...
bashstreamlit run search_engine.py
...
AI Reasoning: The agent analyzes the query and decides which tool to use
Tool Selection:
...
Information Retrieval: The selected tool fetches relevant results
Answer Synthesis: The AI combines findings into a clear, concise answer
...
Max Reasoning Steps: Set how many times the agent can think and act (1-6)
...
GROQ Console - Get API Key
Streamlit Docs
DuckDuckGo Search
arXiv API


Created by: Hussain Murtazaa
